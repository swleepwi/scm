...
<div id="content-header">
    <div id="breadcrumb">
        <a href="#"  class="tip-bottom content_title">New Barcode Scan</a>
    </div>
  </div>
<!-- End Content Title -->
@endsection
		...
		<div class="widget-box">
			...
			<div class="widget-content">
                ...
                <div style="float:right; padding-top:30px;">
                    <button class="btn-small btn-mini search_btn" onclick="window.location='{{url('/')}}/barcode/scan'"><i class="fa fa-backward"></i> Back</button>
                </div>
			</div>
...
<script>
    ...
    var gridMaster = $('#gridMaster').DataTable( {
		...
		columns: [
            ...
            { data: "O_NO", "width": "50px", className: "text-center"  },
