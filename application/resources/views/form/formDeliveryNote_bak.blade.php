...
<div id="content-header">
    <div id="breadcrumb">
        <a href="#"  class="tip-bottom content_title">Delivery Note Input</a>
    </div>
</div>
<!-- End Content Title -->
@endsection
			...
			<div class="widget-box">
				...
				<div class="widget-content">
					...
					<div class="control-group">
						...
						<button style="margin-right: 10px;" class="btn-small btn-mini search_btn" onclick="window.location='{{url('/')}}/dnview/management'"><i class="fa fa-backward"></i> Back</button>
					</div>		
		...
		<div class="widget-box">
			...
			<div class="widget-content nopadding"> 
				<table id="gridPO" class="table table-bordered data-table" style="width: 100%">
					<thead>
						<tr>
							<th style="text-align:center"><input type="checkbox" id="check_all" name="check_all" onclick="checkAll($(this))"></th>
							<th>Barcode</th>
							<th>PO No</th>
							<th>PO Seq</th>                            
							<th>Order No</th>                           
...
<script>
	...
	*/
	...
	{	
		...
		if(out_no !== "")
		{
            popUp("{{url('/')}}/dncreate/dnprint/"+out_no+"/"+out_date, '1250px', '800px')
		}
		else{
