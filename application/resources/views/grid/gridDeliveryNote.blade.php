  ...
  <div class="widget-box">
            <div class="widget-title widget_title_white">
				...
				<div class='export_table'>
                    <button class="btn-small btn-mini btn_pwi" onclick="newDN('{{ url('/') }}/dncreate/new')"><i class="icon icon-plus"></i> New</button>
...
$(document).ajaxStart(function(){
	...
	function filterMaster()
    {
        ...
        if(is_search == "1")
        {
            ...
            if(start_date == "" || end_date == "" )
            {
                ...
                gridMaster.ajax.url("{{url('/')}}/dnview/datalist/"+start_date+"/"+end_date+"/"+po_number+"/"+order_number).load(null, false);
    ...
    {
        console.log("{{url('/')}}/dnview/detaildatalist/"+out_date+"/"+out_number);
		gridDetail.ajax.url("{{url('/')}}/dnview/detaildatalist/"+out_date+"/"+out_number).load();
		$("#span-type").html("Request");
    }
    ...
    function modifyThis()
    {
        ...
        if(obj.SelectedOutNo == "0")
        {
            ...
            //window.location = "{{url('/')}}/dncreate/new/"+out_no+"/"+out_date;

            newDN("{{url('/')}}/dncreate/new/"+out_no+"/"+out_date);
        }
    }
    ...
    function printDN()
	{
		if(obj.SelectedOutNo !== "0")
		{
            popUp("{{url('/')}}/dncreate/dnprint/"+obj.SelectedOutNo+"/"+obj.SelectedOutDate, '1280px', '700px', 'Print Preview')
		}
		else{
			$.bootstrapGrowl("No Selected Data!", {
				type: "error",offset: {from: 'top', amount: 250},align: 'center'
