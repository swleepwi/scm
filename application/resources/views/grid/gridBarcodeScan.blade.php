...
$(document).ajaxStart(function(){
	...
	function filterMaster()
    {
		...
		if(start_date == "" || end_date == "" )
		{
			...
			gridMaster.ajax.url("{{url('/')}}/barcode/datalist/"+start_date+"/"+end_date+"/"+po_number+"/"+order_number).load();
    ...
    {
		gridSize.ajax.url("{{url('/')}}/barcode/detailbarcode/"+po_number+"/"+seq_number).load();
		$("#span-type").html("Request");
    }
    ...
    function newScan()
    {
        popUp("{{ url('/') }}/barcode/barcodescan", '1280px', '700px', 'New Barcode Scan')
    }
