...
<div id="loginbox">    
    <form method="POST" id="loginform" class="form-vertical" action="{{url('/')}}/login/loginaction">
        {{ csrf_field() }}
        <div class="control-group normal_text"> <h3><img src="{{ asset('public') }}/img/logo_depan_system.png" alt="Logo" class="logo_front" /></h3></div>
