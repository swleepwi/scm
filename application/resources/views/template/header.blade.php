...
<div id="header">
  ...
  <div class="wide_div">
    <div id="user-nav" class="navbar navbar-inverse second">
        <ul class="nav">
          <li class=""><span>{{ session('pwiscm_company_name') }} | {{ session('pwiscm_supplier_id') }}</span></li>
        </ul>
    </div>
</div>
...
<section class="animate-menu animate-menu-left animate-menu-open">
    ...
    <ul class="sidebar-menu">
        ...
        <a href="{{ url('/') }}/status/index">
            <i class="icon icon-signal"></i> <span>Status</span>
        </a>
        </li>
        <li>
          <a href="{{ url('/') }}/utility/changepassword">
