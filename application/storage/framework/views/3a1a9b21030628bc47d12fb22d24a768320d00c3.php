...
<script>
    ...
    {        
		...
		if(start_date == "" || end_date == "" )
		{
			...
			gridMaster.ajax.url("<?php echo e(url('/')); ?>/po/datalist/"+start_date+"/"+end_date+"/"+po_number+"/"+order_number).load();
    ...
    {        		
		...
		gridDetail.ajax.url("<?php echo e(url('/')); ?>/po/detaildatalist/"+po_number+"/"+order_number).load();
		$("#span-type").html("Request");
    }
