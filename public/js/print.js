...
<html>
	<head>
		...
		<!-- Scripts -->
		<script src="print.js?v1.2.0"></script>
	...
	<body id="pageBody">
		...
		<section id="header" class="dark">
			...
			<footer>
				<a href="#download" download="print.js" class="button scrolly">Download v1.2.0</a>
			</footer>
		</section>
...
<pre><code data-language="html">
 ...
 &lt;/button&gt;
					...
					<section class="in-link">
						<blockquote>Firefox currently doesn't allow printing PDF documents using iframes. There is an open <a href="https://bugzilla.mozilla.org/show_bug.cgi?id=911444" target="_blank">bug</a> in Mozilla's website about this. When using Firefox, Print.js will open the PDF file into a new tab.</blockquote>
					</section>
				...
				<div class="container" id="download">
					<section>
						...
						<p style="margin-bottom:30px;">
							<a href="https://github.com/crabbly/Print.js/releases/tag/v1.2.0" class="button">Download v1.2.0</a>
						</p>
 ...
 &lt;link rel=&quot;stylesheet&quot; type=&quot;text/css&quot; href=&quot;print.css&quot;&gt;
						...
						<div class="grid">
							...
							<div class="grid-row">
								...
								<div class="g2">When printing html, image or json, this will be shown as the document title. It will also be the name of the document, if the user tries to save the print job to a pdf file.</div>
                            </div>
							<div class="grid-row">
					...
					<section>
						...
						<div class="grid">
							...
							<div class="grid-row">
								...
								<div class="g1"><i class="fa fa-times fa-2x danger" aria-hidden="true"></i></div>
								<div class="g1"><i class="fa fa-check fa-2x success" aria-hidden="true"></i></div>
								<div class="g1"><i class="fa fa-check fa-2x success" aria-hidden="true"></i></div>
		...
		<section id="footer">
			...
			<div class="copyright">
				<ul class="menu">
					<li>&copy; 2019 Crabbly</li><li>Released under the <a href="https://opensource.org/licenses/MIT" target="_blank">MIT License</a></li><li>HTML Template by <a href="https://html5up.net" target="_blank">HTML5 UP</a></li><li>CDN by <a href="https://www.keycdn.com/" target="_blank">KeyCDN</a></li>
				</ul>
			</div>
		</section>
