...
function openSalesOrder() {
    popUp(baseUrl + "/finance/accounting/salesorder/select", '90%', '400px');
}

function salesOrderSelect(so_number)
{
    window.location = baseUrl + "/finance/accounting/salesinvoice/form/fromso/"+so_number;
}
