...
{   
    ...
    if(parseFloat($("#sub_total"+num).val()) > parseFloat($("#remain"+num).val()))
    {
        ...
        $("#vendor_id").change(function()
        {
            ...
            $("#vendor_id").val($("#vendor_id_hide").val());
        });
    }
...
{
    console.log(baseUrl + "/finance/accounting/purchaseinvoice/rawdata?term=" + $(invoiceDom).val() + "&vendor_id=" + $("#vendor_id").val());
    ...
    $(invoiceDom).autocomplete({
        source: function( request, response ) {
            $.ajax({
                url: baseUrl + "/finance/accounting/purchaseinvoice/rawdata?term=" + $(invoiceDom).val() + "&vendor_id=" + $("#vendor_id").val(),
                dataType: "json",
...
function vendorSelected(value)
{
    $("#vendor_id_hide").val(value); 
}