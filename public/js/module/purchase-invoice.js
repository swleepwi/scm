...
{
    window.location = baseUrl + "/finance/accounting/purchaseinvoice/form/frompo/"+po_number;
}
...
function itemAutoCompleteBind(num)
{
    ...
    $(itemDom).autocomplete({
        source: function( request, response ) {
            $.ajax({
                url: baseUrl + "/finance/inventory/item/rawdata?term=" + $(itemDom).val() +"&trans_type=purchase",
                dataType: "json",
